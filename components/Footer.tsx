        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:justify-between gap-10 lg:gap-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-5 mt-4 md:mt-[40px]">
              {/* X (Twitter) */}
              <Link href="https://x.com/OwlyStudioai" className="text-white hover:text-gray-300 transition-colors" aria-label="Owly on X">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </Link>
              {/* Discord */}
              <Link href="https://www.owly.studio" className="text-white hover:text-gray-300 transition-colors" aria-label="Owly website">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* LinkedIn */}
              <Link href="https://www.linkedin.com/company/owlystudios/posts/?feedView=all" className="text-white hover:text-gray-300 transition-colors" aria-label="Owly on LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-8 sm:gap-12 lg:gap-[60px]">
            ...
            <div className="flex flex-col gap-4 md:gap-[22px]">
              ...
              <div className="flex flex-col gap-2 md:gap-[10px] text-[#dbdbdb] text-[15px]">
                <Link href="https://www.linkedin.com/company/owlystudios/posts/?feedView=all" className="hover:text-white transition-colors">LinkedIn</Link>
                <Link href="https://x.com/OwlyStudioai" className="hover:text-white transition-colors">Twitter</Link>
                <Link href="https://www.instagram.com/owly.studios/" className="hover:text-white transition-colors">Instagram</Link>
                <p className="mt-2 md:mt-[10px]">+91 9188589920</p>
                <p>Bengaluru, India</p>
              </div>
            </div>
          </div>
