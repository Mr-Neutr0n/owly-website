...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[98vw] md:max-w-[94vw] mx-auto h-[calc(100vh-80px)] min-h-[600px] max-h-[1100px] border-2 border-[#3a3a3a] p-1 bg-[#1a1a1a] rounded-[20px] shadow-2xl"
    >
